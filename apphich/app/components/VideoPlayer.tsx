  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95">
      ...
      <div className="relative h-full w-full">
        ...
        {/* Controls */}
        <div className="absolute bottom-0 left-0 right-0 translate-y-8 bg-gradient-to-t from-black/90 to-transparent px-4 py-8 transition hover:translate-y-0">
          {/* Progress Bar */}
          ...
          <div className="flex items-center justify-between">
            <div className="flex gap-4">
              ...
              {/* Volume */}
              <button className="rounded-lg p-2 hover:bg-netflix-black-lighter">
